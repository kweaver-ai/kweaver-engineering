...
- 上位本体指南：`docs/guides/《KWeaver BKN 本体建模与 AI 工程应用指南》.md` 和 `docs/guides/《Palantir Ontology 建模规范及 AIP 应用指南》.md`。凡涉及对象、属性、关系、逻辑、Action、治理和 Agent / Skill 应用层判定，以这两份指南为准；本 skill reference 只做需求发现阶段的落地转译。
